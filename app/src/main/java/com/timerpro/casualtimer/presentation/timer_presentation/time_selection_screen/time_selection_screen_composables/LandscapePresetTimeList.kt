...
import com.timerpro.casualtimer.presentation.timer_presentation.edit_preset_time_dialog.edit_preset_time_dialog_layouts.LandscapeEditPresetTimeDialog

@Composable
fun LandscapePresetTimeList(
    context: Context,
    ...
    LazyColumn (
        ...
        items(timerStates.presetTimeList) { presetTime ->
            ...
            // Landscape Edit Preset Time Dialog
            LandscapeEditPresetTimeDialog(
                context = context,
                configuration = configuration,
